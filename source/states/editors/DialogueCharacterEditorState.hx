...
class DialogueCharacterEditorState extends MusicBeatState
{
	...
	override function update(elapsed:Float) {
		...
		if(!blockInput && !animationDropDown.dropPanel.visible) {
			...
			if(FlxG.keys.justPressed.SPACE || mobilePad.getButtonFromName.get('buttonA').justPressed && UI_mainbox.selected_tab_id == 'Character') {
			...
			if(UI_mainbox.selected_tab_id == 'Animations' && curSelectedAnim != null && character.dialogueAnimations.exists(curSelectedAnim)) {
				...
				var animShit:DialogueAnimArray = character.dialogueAnimations.get(curSelectedAnim);
				var controlArrayLoop:Array<Bool> = [FlxG.keys.justPressed.A || mobilePad.getButtonFromName.get('buttonLeft2').justPressed, FlxG.keys.justPressed.W || mobilePad.getButtonFromName.get('buttonUp2').justPressed, FlxG.keys.justPressed.D || mobilePad.getButtonFromName.get('buttonRight2').justPressed, FlxG.keys.justPressed.S || mobilePad.getButtonFromName.get('buttonDown2').justPressed];
				var controlArrayIdle:Array<Bool> = [FlxG.keys.justPressed.LEFT || mobilePad.getButtonFromName.get('buttonLeft').justPressed, FlxG.keys.justPressed.UP || mobilePad.getButtonFromName.get('buttonUp').justPressed, FlxG.keys.justPressed.RIGHT || mobilePad.getButtonFromName.get('buttonRight').justPressed, FlxG.keys.justPressed.DOWN || mobilePad.getButtonFromName.get('buttonDown').justPressed];
			...
			if(FlxG.keys.justPressed.H || mobilePad.getButtonFromName.get('buttonY').justPressed) {
			...
			if(FlxG.keys.justPressed.R || mobilePad.getButtonFromName.get('buttonX').justPressed) {
				camGame.zoom = 1;
			...
			if(FlxG.keys.justPressed.ESCAPE #if android || FlxG.android.justPressed.BACK #end || mobilePad.getButtonFromName.get('buttonB').justPressed) {
